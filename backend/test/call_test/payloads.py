"""Sample request bodies matching the Aminyx backend contract."""
...
def suggestion_job_payload(
    *,
    ...
    callback_url: str = "http://aminyx-backend:8600/api/internal/webhooks/suggestion-agent",
) -> dict[str, Any]:
    return {
...
def strategy_content_job_payload(
    *,
    ...
    callback_url: str = "http://aminyx-backend:8600/api/internal/webhooks/strategy-content-agent",
) -> dict[str, Any]:
    return {
        "businessData": sample_business_data(),
